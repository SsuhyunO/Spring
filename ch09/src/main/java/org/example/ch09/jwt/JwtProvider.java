...
public class JwtProvider {
    ...
    public String createToken(User user, int day){
        ...
        Date expiredDate = new Date(issuedDate.getTime() + Duration.ofDays(day).toMillis());
    ...
    public void validateToken(String token){
        try {
            ...
            throw new RuntimeException("토큰 서명일 잘못되었습니다.");
        }catch (JwtException e){
            throw new RuntimeException("유효하지 않은 토큰입니다.");
        }catch (Exception e){
            throw new RuntimeException("기타 토큰 검증에 실패했습니다.");
        }
    }

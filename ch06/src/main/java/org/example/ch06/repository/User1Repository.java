...
public interface User1Repository extends JpaRepository<User1, String> {
    ...
    public List<User1> findByHp(String hp);                     // SELECT * FROM User1 WHERE hp={hp}
    ...
    public List<User1> findByNameContains(String name);    // SELECT * FROM User1 WHERE name CONTAIN '%{name}';
    public List<User1> findByNameStartsWith(String name);    // SELECT * FROM User1 WHERE name startsWith '%{name}';
    public List<User1> findByNameEndsWith(String name);    // SELECT * FROM User1 WHERE name EndsWith '%{name}';
    ...
    @Query("SELECT u.userid, u.name, u.age " +
            "FROM User1 AS u WHERE u.userid = :userid")
